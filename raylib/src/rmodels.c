...
// Draw OBB wires
void DrawOBBWires(Vector3 position, Vector3 x_axis, Vector3 y_axis, Vector3 z_axis, Vector3 hlf_ext, Color color)
{
	float x = 0.0f;
	float y = 0.0f;
	float z = 0.0f;
...
//TODO: fix this
	...
	//Try using matrix look at lol
	Matrix m = MatrixLookAt(Vector3Zero(), z_axis, y_axis);
	...
	// Front Face -----------------------------------------------------
	// Bottom Line
	rlVertex3f(x - hlf_ext.x, y - hlf_ext.y, z + hlf_ext.z);  // Bottom Left
	rlVertex3f(x + hlf_ext.x, y - hlf_ext.y, z + hlf_ext.z);  // Bottom Right

	// Left Line
	rlVertex3f(x + hlf_ext.x, y - hlf_ext.y, z + hlf_ext.z);  // Bottom Right
	rlVertex3f(x + hlf_ext.x, y + hlf_ext.y, z + hlf_ext.z);  // Top Right

	// Top Line
	rlVertex3f(x + hlf_ext.x, y + hlf_ext.y, z + hlf_ext.z);  // Top Right
	rlVertex3f(x - hlf_ext.x, y + hlf_ext.y, z + hlf_ext.z);  // Top Left
	...
	// Top Face -------------------------------------------------------
	// Left Line
	rlVertex3f(x - hlf_ext.x, y + hlf_ext.y, z + hlf_ext.z);  // Top Left Front
	rlVertex3f(x - hlf_ext.x, y + hlf_ext.y, z - hlf_ext.z);  // Top Left Back

	// Right Line
	rlVertex3f(x + hlf_ext.x, y + hlf_ext.y, z + hlf_ext.z);  // Top Right Front
	rlVertex3f(x + hlf_ext.x, y + hlf_ext.y, z - hlf_ext.z);  // Top Right Back
...
void DrawCylinder(Vector3 position, Vector3 pointDir, float radiusTop, float radiusBottom, float height, int sides, Color color)
{
    if (sides < 3) sides = 3;
    ...
    rlPushMatrix();
        rlTranslatef(position.x, position.y, position.z);
				pointDir = Vector3Normalize(pointDir);
				Vector3 axis = Vector3CrossProduct(pointDir, (Vector3) { 0, -1, 0 });
				float angle = RAD2DEG * acosf(Vector3DotProduct(pointDir, (Vector3) { 0, 1, 0 }));
