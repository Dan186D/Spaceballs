...
RLAPI void DrawOBBWires(Vector3 position, Vector3 x_axis, Vector3 y_axis, Vector3 z_axis, Vector3 hlf_ext, Color color);
...
RLAPI void DrawCylinder(Vector3 position, Vector3 pointDir, float radiusTop, float radiusBottom, float height, int slices, Color color); // Draw a cylinder/cone
